...
**Key Insight:**
Config from environment - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_default_from_env(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
env::var("CONFIG").unwrap_or_else(|_| "default".to_string())
...
1. **Config from environment** - The core concept being practiced
...
**[← Previous Exercise](../ex417_/README.md) | [Next Exercise →](../ex419_/README.md)**
