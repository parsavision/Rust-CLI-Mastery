...
**Key Insight:**
Multi-condition check - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_validate_range(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
`fn in_range(n: i32, min: i32, max: i32) -> bool`
...
1. **Multi-condition check** - The core concept being practiced
...
**[← Previous Exercise](../ex125_/README.md) | [Next Exercise →](../ex127_/README.md)**
