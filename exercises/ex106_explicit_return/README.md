...
**Trade-offs:**
- ⚠️ Not validating function inputs or assuming valid data
...
**Why this is better:**
- ✅ Validate inputs and return Result for fallible operations
- ✅ Handles errors explicitly
- ✅ Follows Rust conventions
- ✅ Production-ready code

**Key Insight:**
return keyword exits early - apply this concept with proper error handling and safety considerations.
...
// Not validating function inputs or assuming valid data
```
...
- `missing_panics_doc`: Category-specific guidance
- `must_use_candidate`: Category-specific guidance

**What Clippy teaches:**
Apply idiomatic Rust patterns and avoid common pitfalls specific to functions.
...
**Example signature:**
```rust
fn process_explicit_return(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **return keyword exits early** - The core concept being practiced
...
**[← Previous Exercise](../ex105_/README.md) | [Next Exercise →](../ex107_/README.md)**

**Phase:** Functions | **Difficulty:** Progressive
