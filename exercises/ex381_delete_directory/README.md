...
**Key Insight:**
Only works if empty - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_delete_directory(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Only works if empty** - The core concept being practiced
...
**[← Previous Exercise](../ex380_/README.md) | [Next Exercise →](../ex382_/README.md)**
