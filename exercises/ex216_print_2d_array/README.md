...
**Key Insight:**
Row-by-row iteration - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_print_2d_array(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Row-by-row iteration** - The core concept being practiced
...
**[← Previous Exercise](../ex215_/README.md) | [Next Exercise →](../ex217_/README.md)**
