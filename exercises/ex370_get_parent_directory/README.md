...
**Key Insight:**
Remove last component - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_get_parent_directory(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Remove last component** - The core concept being practiced
...
**[← Previous Exercise](../ex369_/README.md) | [Next Exercise →](../ex371_/README.md)**
