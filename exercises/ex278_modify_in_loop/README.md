...
**Key Insight:**
Mutable iteration - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_modify_in_loop(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Mutable iteration** - The core concept being practiced
...
**[← Previous Exercise](../ex277_/README.md) | [Next Exercise →](../ex279_/README.md)**
