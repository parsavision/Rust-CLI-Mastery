...
**Key Insight:**
Main program loop - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_menu_loop(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Main program loop** - The core concept being practiced
...
**[← Previous Exercise](../ex179_/README.md) | [Next Exercise →](../ex181_/README.md)**
