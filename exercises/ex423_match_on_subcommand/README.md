...
**Key Insight:**
Command routing - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_match_on_subcommand(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
match args[1].as_str() { "add" => ..., "remove" => ... }
...
1. **Command routing** - The core concept being practiced
...
**[← Previous Exercise](../ex422_/README.md) | [Next Exercise →](../ex424_/README.md)**
