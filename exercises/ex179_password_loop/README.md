...
**Key Insight:**
Authentication pattern - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_password_loop(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Authentication pattern** - The core concept being practiced
...
**[← Previous Exercise](../ex178_/README.md) | [Next Exercise →](../ex180_/README.md)**
