...
**Key Insight:**
Multi-criteria validation - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_password_strength(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
Check length, has number, has symbol
...
1. **Multi-criteria validation** - The core concept being practiced
...
**[← Previous Exercise](../ex168_/README.md) | [Next Exercise →](../ex170_/README.md)**
