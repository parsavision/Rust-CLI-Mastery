...
**Key Insight:**
Menu-driven logic - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_menu_selection(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
If 1 do X, if 2 do Y, else invalid
...
1. **Menu-driven logic** - The core concept being practiced
...
**[← Previous Exercise](../ex169_/README.md) | [Next Exercise →](../ex171_/README.md)**
