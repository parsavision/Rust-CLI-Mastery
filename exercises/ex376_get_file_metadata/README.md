...
**Key Insight:**
Size, permissions, timestamps - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_get_file_metadata(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Size, permissions, timestamps** - The core concept being practiced
...
**[← Previous Exercise](../ex375_/README.md) | [Next Exercise →](../ex377_/README.md)**
