...
**Key Insight:**
Err contains error info - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_err_variant(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
`let r: Result<i32, String> = Err("Failed".to_string());`
...
1. **Err contains error info** - The core concept being practiced
...
**[← Previous Exercise](../ex313_/README.md) | [Next Exercise →](../ex315_/README.md)**
