...
**Key Insight:**
Iterator over lines - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_read_line_by_line(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Iterator over lines** - The core concept being practiced
...
**[← Previous Exercise](../ex358_/README.md) | [Next Exercise →](../ex360_/README.md)**
