...
**Key Insight:**
Flexible functions - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_function_with_error_string(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
Function takes error text as parameter
...
1. **Flexible functions** - The core concept being practiced
...
**[← Previous Exercise](../ex117_/README.md) | [Next Exercise →](../ex119_/README.md)**
