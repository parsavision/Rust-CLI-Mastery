...
**Key Insight:**
Bidirectional operations - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_fahrenheit_to_celsius(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Bidirectional operations** - The core concept being practiced
...
**[← Previous Exercise](../ex121_/README.md) | [Next Exercise →](../ex123_/README.md)**
