...
**Key Insight:**
Avoid nested match - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_result_combinators(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
Use map, map_err, and_then together
...
1. **Avoid nested match** - The core concept being practiced
...
**[← Previous Exercise](../ex340_/README.md) | [Next Exercise →](../ex342_/README.md)**
