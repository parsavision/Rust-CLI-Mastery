...
**Trade-offs:**
- ⚠️ Unnecessary clones or moving when borrowing would work
...
**Why this is better:**
- ✅ Understand borrowing rules and use references appropriately
- ✅ Handles errors explicitly
- ✅ Follows Rust conventions
- ✅ Production-ready code

**Key Insight:**
Stack-only types usually Copy - apply this concept with proper error handling and safety considerations.
...
// Unnecessary clones or moving when borrowing would work
```
...
- `clone_on_copy`: Category-specific guidance
- `needless_borrow`: Category-specific guidance

**What Clippy teaches:**
Apply idiomatic Rust patterns and avoid common pitfalls specific to ownership.
...
**Example signature:**
```rust
fn process_which_types_copy(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
Test: integers, floats, bool, char
...
1. **Stack-only types usually Copy** - The core concept being practiced
...
**[← Previous Exercise](../ex255_/README.md) | [Next Exercise →](../ex257_/README.md)**

**Phase:** Ownership | **Difficulty:** Progressive
