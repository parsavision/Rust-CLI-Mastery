...
**Key Insight:**
UI helper functions - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_print_menu_function(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **UI helper functions** - The core concept being practiced
...
**[← Previous Exercise](../ex119_/README.md) | [Next Exercise →](../ex121_/README.md)**
