...
**Key Insight:**
Three-way comparison - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_sign_function(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
Indicate if negative, zero, or positive
...
1. **Three-way comparison** - The core concept being practiced
...
**[← Previous Exercise](../ex127_/README.md) | [Next Exercise →](../ex129_/README.md)**
