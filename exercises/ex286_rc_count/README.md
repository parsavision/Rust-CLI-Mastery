...
**Key Insight:**
Track number of owners - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_rc_count(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Track number of owners** - The core concept being practiced
...
**[← Previous Exercise](../ex285_/README.md) | [Next Exercise →](../ex287_/README.md)**
