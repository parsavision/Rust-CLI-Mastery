...
**Key Insight:**
Multiple inputs - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_rectangle_area(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Multiple inputs** - The core concept being practiced
...
**[← Previous Exercise](../ex123_/README.md) | [Next Exercise →](../ex125_/README.md)**
