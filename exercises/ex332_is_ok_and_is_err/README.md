...
## 🎯 Goal
Check Result without consuming
...
**Key Insight:**
Boolean checks - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_is_ok_and_is_err(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Boolean checks** - The core concept being practiced
...
**[← Previous Exercise](../ex331_/README.md) | [Next Exercise →](../ex333_/README.md)**
