...
**Key Insight:**
Unit type () is implicit - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_void_function(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
1. **Unit type () is implicit** - The core concept being practiced
...
**[← Previous Exercise](../ex118_/README.md) | [Next Exercise →](../ex120_/README.md)**
