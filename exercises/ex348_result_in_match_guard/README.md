...
**Key Insight:**
Advanced pattern matching - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_result_in_match_guard(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
Use Result in match expression
...
1. **Advanced pattern matching** - The core concept being practiced
...
**[← Previous Exercise](../ex347_/README.md) | [Next Exercise →](../ex349_/README.md)**
