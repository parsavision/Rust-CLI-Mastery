...
**Key Insight:**
Nested conditions - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_nested_if(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
Check age, then check citizenship
...
1. **Nested conditions** - The core concept being practiced
...
**[← Previous Exercise](../ex161_/README.md) | [Next Exercise →](../ex163_/README.md)**
