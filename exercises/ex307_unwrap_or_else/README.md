...
**Key Insight:**
Lazy default value - apply this concept with proper error handling and safety considerations.
...
**Example signature:**
```rust
fn process_unwrap_or_else(input: &str) -> Result<OutputType, String> {
    // Your implementation
}
```
...
.unwrap_or_else(|| expensive_computation())
...
1. **Lazy default value** - The core concept being practiced
...
**[← Previous Exercise](../ex306_/README.md) | [Next Exercise →](../ex308_/README.md)**
